...
export default function LanguageToggle({ className = '' }: LanguageToggleProps) {
  ...
  return (
    <button
      ...
      className={`p-2 rounded-lg transition-colors duration-200 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-[#f4f4f4] flex items-center justify-center focus:outline-none ${className}`}
