...
export default function SecondButton({ children = 'Contattaci', className = '', ...props }: ButtonProps) {
  return (
    <button
    ...
    >
      ...
      <Image src="/icons/diagonal-arrow.svg" alt="Arrow" width={12} height={12} className="arrow translate-y-[1px]" />
    </button>
  );
} 