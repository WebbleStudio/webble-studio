        ...
        <div className="bg-[#0b0b0b] rounded-[32px] border border-[#f4f4f4]/10 p-3 md:hidden">
          ...
          >
                ...
                {openQuote === 'matias' && (
                  ...
                  >
                    <div className="text-center">
                      <svg className="w-8 h-8 mx-auto mb-2 text-white/40" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="p-4 bg-[#121212]">
              <div className="flex items-end justify-between">
                <div>
                  <h3 className="text-white text-lg sm:text-xl font-medium">{t('team.matias.name')}</h3>
          ...
          >
            ...
            <div className="p-4 bg-[#121212]">
              <div className="flex items-end justify-between">
                <div>
                  <h3 className="text-white text-lg sm:text-xl font-medium">{t('team.victor.name')}</h3>
          ...
          >
            ...
            <div className="p-4 bg-[#121212]">
              <div className="flex items-end justify-between">
                <div>
                  <h3 className="text-white text-lg sm:text-xl font-medium">{t('team.anselmo.name')}</h3>
          ...
          >
            ...
            <div className="p-4 bg-[#121212]">
              <div className="flex items-end justify-between">
                <div>
                  <h3 className="text-white text-lg sm:text-xl font-medium">{t('team.imane.name')}</h3>
