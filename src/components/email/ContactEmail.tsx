      ...
      <div style={{ padding: '40px' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <p style={{ 
            ...
            Grazie per aver scelto <strong>Webble Studio</strong>! Abbiamo ricevuto la tua richiesta e siamo entusiasti di trasformare la tua visione in realtà digitale.
          </p>
        </div>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <div style={{ 
            ...
            {['🎨 UI/UX Design', '⚡ Sviluppo Web', '📱 App Mobile', '🚀 E-commerce', '📊 Analytics & SEO'].map((service, index) => (
              <div key={index} style={{ 
                padding: '12px 16px',
                backgroundColor: 'white',
                borderRadius: '6px',
        ...
        <div style={{ textAlign: 'center', margin: '40px 0' }}>
          <a href="https://webble.studio" style={{ 
            backgroundColor: '#020202', 
            color: 'white', 
            padding: '16px 32px', 
            textDecoration: 'none', 
        ...
        <div style={{ 
          ...
          <p style={{ 
            ...
            📧 <a href="mailto:info@webblestudio.com" style={{ color: '#020202', textDecoration: 'none' }}>info@webblestudio.com</a>
          </p>
          <p style={{ 
            margin: '0', 
            fontSize: '14px', 
