            ...
            <div className="flex-1 min-w-0 space-y-12">
              ...
              >
                ...
                <div className="text-gray-700 dark:text-[#fafafa]/80 space-y-2">
                  <p>
                    <strong>{t('cookies.privacy.controller.brand')}</strong>{' '}
                    {t('cookies.privacy.controller.brand_val')}
                  </p>
                  <p>
                    <strong>{t('cookies.privacy.controller.company')}</strong>{' '}
                    {t('cookies.privacy.controller.company_val')}
                  </p>
                  <p>
                    <strong>{t('cookies.privacy.controller.address')}</strong>{' '}
              ...
              <section id="rights" className="scroll-mt-24">
                ...
                <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800/30 rounded-lg">
                  <p className="text-sm text-gray-700 dark:text-[#fafafa]/80">
                    ...
                    . {t('cookies.privacy.rights.response')}
                  </p>
                </div>
              </section>
              ...
              <section id="authority" className="scroll-mt-24">
                ...
                <div className="bg-white dark:bg-[rgba(250,250,250,0.02)] border border-gray-200 dark:border-[rgba(250,250,250,0.1)] rounded-xl p-6">
                  ...
                  <div className="space-y-2 text-gray-700 dark:text-[#fafafa]/80">
                    <p>
                      <strong>{t('cookies.privacy.authority.name')}</strong>
                    </p>
                    <p className="ml-4">{t('cookies.privacy.authority.address')}</p>
                    <p className="ml-4">
                      <strong>{t('cookies.privacy.authority.phone')}</strong>{' '}
                      <a href="tel:+39066977" className="text-[#F20352] hover:underline">
                        +39 06.69677.1
                      </a>
                    </p>
                    <p className="ml-4">
                      <strong>Fax:</strong> +39 06.69677.3785
                    </p>
                    <p className="ml-4">
                      <strong>{t('cookies.privacy.authority.email')}</strong>{' '}
                      <a href="mailto:garante@gpdp.it" className="text-[#F20352] hover:underline">
                        garante@gpdp.it
                      </a>
                    </p>
                    <p className="ml-4">
                      <strong>{t('cookies.privacy.authority.pec')}</strong>{' '}
                      <a
                    ...
                    <p className="ml-4">
                      <strong>{t('cookies.privacy.authority.website')}</strong>{' '}
                      <a
              ...
              >
                ...
                <div className="text-gray-700 dark:text-[#fafafa]/80 space-y-1">
                  <p>
                    <strong>{t('cookies.privacy.contacts.brand')}</strong>
                  </p>
                  <p>{t('cookies.privacy.contacts.company')}</p>
                  <p>{t('cookies.privacy.contacts.address')}</p>
                  <p className="mt-3">
                    <strong>{t('cookies.privacy.contacts.email')}</strong>{' '}
                    <a
                      href="mailto:webblestudio.com@gmail.com"
                      className="text-[#F20352] hover:underline"
                    >
