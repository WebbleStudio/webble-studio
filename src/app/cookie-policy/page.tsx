    ...
    <div className="min-h-screen bg-[#f4f4f4] dark:bg-[#0b0b0b] transition-colors duration-500">
      ...
      <div className="pt-[45px] pb-32">
        <Container>
          ...
          {/* Titolare */}
          <section id="titolare" className="bg-white dark:bg-[rgba(250,250,250,0.02)] border border-gray-200 dark:border-[rgba(250,250,250,0.1)] rounded-xl p-6 scroll-mt-24">
            ...
            <div className="text-gray-700 dark:text-[#fafafa]/80 space-y-2">
              <p><strong>{t('cookies.policy.sections.data_controller.brand')}</strong> {t('cookies.policy.sections.contacts.brand')}</p>
              <p><strong>{t('cookies.policy.sections.data_controller.company')}</strong> {t('cookies.policy.sections.contacts.company')}</p>
              <p><strong>{t('cookies.policy.sections.data_controller.address')}</strong> {t('cookies.policy.sections.contacts.address')}</p>
              <p><strong>{t('cookies.policy.sections.data_controller.ein')}</strong> 32-0774843</p>
              <p><strong>{t('cookies.policy.sections.data_controller.email')}</strong> <a href="mailto:webblestudio.com@gmail.com" className="text-[#F20352] hover:underline">webblestudio.com@gmail.com</a></p>
            </div>
          </section>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-gray-600 dark:text-[#fafafa]/80 list-disc list-inside space-y-1">
                      <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">_ga</code> - 2 anni</li>
                      <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">_ga_*</code> - 2 anni</li>
                      <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">_gid</code> - 24 ore</li>
                      <li><code className="bg-gray-100 dark:bg-gray-800 px-1 py-0.5 rounded">_gat</code> - 1 minuto</li>
                    </ul>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800/30 rounded-lg p-3">
                      <p className="text-sm text-gray-600 dark:text-[#fafafa]/80">
                        <strong>Nota:</strong> {t('cookies.policy.sections.marketing_section.gtm.cookies_note')}
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <section id="base-giuridica" className="scroll-mt-24">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-gray-400 dark:border-gray-600 pl-4">
                ...
                <p className="text-gray-700 dark:text-[#fafafa]/80 leading-relaxed">
                  <strong>{t('cookies.policy.sections.legal_basis.functional_basis')}</strong> {t('cookies.policy.sections.legal_basis.functional_article')}
                </p>
              ...
              <div className="border-l-4 border-blue-500 dark:border-blue-400 pl-4">
                ...
                <p className="text-gray-700 dark:text-[#fafafa]/80 leading-relaxed">
                  <strong>{t('cookies.policy.sections.legal_basis.marketing_basis')}</strong> {t('cookies.policy.sections.legal_basis.marketing_article')}
                </p>
                <p className="text-sm text-gray-600 dark:text-[#fafafa]/70 mt-2">
          ...
          <section id="trasferimenti" className="scroll-mt-24">
            ...
            <div className="space-y-4">
              <div className="bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800/30 rounded-xl p-6">
                ...
                <p className="text-gray-700 dark:text-[#fafafa]/80 leading-relaxed mb-4">
                  <strong>Vady Solutions LLC</strong> {t('cookies.policy.sections.transfers.us_company_text1')} <strong>Stati Uniti (Delaware)</strong>. 
                  {t('cookies.policy.sections.transfers.us_company_text2')} <strong>GDPR (Regolamento Generale sulla Protezione dei Dati)</strong> {t('cookies.policy.sections.transfers.us_company_text3')}
                </p>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800/30 rounded-xl p-6">
                ...
                <p className="text-sm text-gray-700 dark:text-[#fafafa]/80 leading-relaxed">
                  {t('cookies.policy.sections.transfers.google_text2')} <strong>{t('cookies.policy.sections.transfers.google_framework')}</strong>, {t('cookies.policy.sections.transfers.google_text3')} <strong>{t('cookies.policy.sections.transfers.google_scc')}</strong> {t('cookies.policy.sections.transfers.google_text4')}
                </p>
          ...
          <section id="conservazione" className="scroll-mt-24">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800/30 rounded-lg p-4 mt-4">
                ...
                <p className="text-sm text-gray-600 dark:text-[#fafafa]/80">
                  {t('cookies.policy.sections.retention.validity_text')} <strong>{t('cookies.policy.sections.retention.validity_days')}</strong>. {t('cookies.policy.sections.retention.validity_text2')}
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-100 dark:bg-[rgba(250,250,250,0.05)] border border-gray-200 dark:border-[rgba(250,250,250,0.1)] rounded-lg p-4 mt-4">
                <p className="text-sm text-gray-700 dark:text-[#fafafa]/80">
                  <strong>Nota importante:</strong> {t('cookies.policy.sections.consequences.note')}
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="diritti" className="scroll-mt-24">
            ...
            <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800/30 rounded-lg">
              <p className="text-sm text-gray-700 dark:text-[#fafafa]/80">
                ...
                <a href="mailto:webblestudio.com@gmail.com" className="text-[#F20352] hover:underline">webblestudio.com@gmail.com</a>. {t('cookies.policy.sections.rights.exercise_response')}
              </p>
            </div>
          </section>
          ...
          <section id="autorita" className="scroll-mt-24">
            ...
            <div className="bg-white dark:bg-[rgba(250,250,250,0.02)] border border-gray-200 dark:border-[rgba(250,250,250,0.1)] rounded-xl p-6">
              ...
              <div className="space-y-2 text-gray-700 dark:text-[#fafafa]/80">
                <p><strong>{t('cookies.policy.sections.authority.italy')}</strong></p>
                <p className="ml-4"><strong>{t('cookies.policy.sections.authority.name')}</strong></p>
                <p className="ml-4">Piazza Venezia, 11 - 00187 Roma</p>
                <p className="ml-4"><strong>{t('cookies.policy.sections.authority.phone')}</strong> <a href="tel:+39066977" className="text-[#F20352] hover:underline">+39 06.69677.1</a></p>
                <p className="ml-4"><strong>{t('cookies.policy.sections.authority.fax')}</strong> +39 06.69677.3785</p>
                <p className="ml-4"><strong>Email:</strong> <a href="mailto:garante@gpdp.it" className="text-[#F20352] hover:underline">garante@gpdp.it</a></p>
                <p className="ml-4"><strong>PEC:</strong> <a href="mailto:protocollo@pec.gpdp.it" className="text-[#F20352] hover:underline">protocollo@pec.gpdp.it</a></p>
                <p className="ml-4"><strong>{t('cookies.policy.sections.authority.website')}</strong> <a href="https://www.garanteprivacy.it" target="_blank" rel="noopener noreferrer" className="text-[#F20352] hover:underline">www.garanteprivacy.it</a></p>
              </div>
            </div>
          </section>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="border border-gray-200 dark:border-[rgba(250,250,250,0.1)] rounded-xl p-6">
                ...
                <div className="bg-white dark:bg-[rgba(250,250,250,0.05)] rounded-lg p-3 border border-gray-200 dark:border-[rgba(250,250,250,0.1)]">
                  <p className="text-sm font-medium text-gray-900 dark:text-[#fafafa] mb-1">{t('cookies.policy.sections.first_third.first_examples')}</p>
              ...
              <div className="border border-gray-200 dark:border-[rgba(250,250,250,0.1)] rounded-xl p-6">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/10 rounded-lg p-3">
                  <p className="text-sm font-medium text-gray-900 dark:text-[#fafafa] mb-1">{t('cookies.policy.sections.first_third.third_examples')}</p>
                  <ul className="text-sm text-gray-600 dark:text-[#fafafa]/80 list-disc list-inside">
          ...
          <section id="gestione" className="scroll-mt-24">
            ...
            <div className="space-y-4">
              <div className="bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800/30 rounded-xl p-6">
                ...
                <p className="text-gray-700 dark:text-[#fafafa]/80 leading-relaxed mb-3">
                  {t('cookies.policy.sections.management.site_text')} <strong>{t('cookies.policy.sections.management.site_button')}</strong> {t('cookies.policy.sections.management.site_location')} <strong>{t('cookies.policy.sections.management.site_position')}</strong>.
                </p>
                <p className="text-sm text-gray-600 dark:text-[#fafafa]/70">
          ...
          {/* Privacy Policy Link */}
          <section id="privacy-policy" className="bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800/30 rounded-xl p-6 scroll-mt-24">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-[#fafafa] mb-4">
          ...
          {/* Contatti */}
          <section id="contatti" className="border-t border-gray-200 dark:border-[rgba(250,250,250,0.1)] pt-8 scroll-mt-24">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-[#fafafa] mb-4">
            ...
            <div className="text-gray-700 dark:text-[#fafafa]/80 space-y-1">
              <p><strong>{t('cookies.policy.sections.contacts.brand')}</strong></p>
              <p>{t('cookies.policy.sections.contacts.company')}</p>
              <p>{t('cookies.policy.sections.contacts.address')}</p>
              <p className="mt-3"><strong>{t('cookies.policy.sections.contacts.email')}</strong> <a href="mailto:webblestudio.com@gmail.com" className="text-[#F20352] hover:underline">webblestudio.com@gmail.com</a></p>
            </div>
          </section>
